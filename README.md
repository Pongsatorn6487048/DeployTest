...
## T4: 'testgetBestTimeForStage()'

### วัตถุประสงค์
จุดประสงค์ของ test case คือ สร้างขึ้นมาเพื่อตรวจสอบว่า bestTime มีข้อมูลที่เก็บไว้อยู่หรือเปล่าถ้ามี จะถูกแปลงหน่วยให้เป็น minutes, seconds และ คืนค่ากลับในรูปแบบ String 
...
* Partition characteristics
  ...
  | C1: Theme id is correct      | True  | False  |
  | C2: Difficulty value is correct  | True  | False   |
  | C2: bestTime value is correct  | True | False  |
...
4. Combine partitions into tests
   ...
   * C1:C2 -> (C1b1, C2b1, C3b1) , (C1b2, C2b2, C3b2)
5. Derive test values
   
   |   Test  | Theme  | Difficulty | BestTime | Expected result |
     |----- | :-------------: | :-------------: | :-------------: | :-------------: |
     |T1(C1b1, C2b1, C3b1) | 1 | 1  | 125   | BEST : 02:05   |
     |T2(True, False) | -1 | -1  | -125  | BEST : -  |
